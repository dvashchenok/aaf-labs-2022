            ...
            if len(table_1.values) == len(table_2.values):
                if command[9][0] == '"':
                    ...
                    try:
                        ...
                        print(f"There is no column called {command[5]} in the table {command[1]}!")
                        return
                    try:
                        index_column_join_2 = table_2.columns.index(command[6])
                    except:
                        print(f"There is no column called {command[6]} in the table {command[3]}!")
                        return
                    i = 0
                    check_where = False
                    check_join = False
                    while i < len(table_1.values):
                        ...
                        while j < len(table_2.values):
                            if check_table == 1:
                                if (table_1.values[i][index_column_where_1] > command[9]):
                                    check_where = True
                                if  (table_1.values[i][index_column_join_1] == table_2.values[j][index_column_join_2]):
                                     check_join = True
                            ...
                            j += 1
                        i += 1
                    if values == [] and check_where == False and check_join == True:
                        i = 0
                        while i < len(table_1.values):
                            values.append(table_1.values[i] + table_2.values[i])
                            i += 1
                        ...
                        tab.add_rows(table[1:])
                        print(tab)
                    elif values == [] and check_join == False and check_where == True:
                        i = 0
                        while i < len(table_1.values):
                            j = 0
                            while j < len(table_2.values):
                        ...
                        tab.add_rows(table[1:])
                        print(tab)
                    elif values == [] and check_join == False and check_where == False:
                        i = 0
                        while i < len(table_1.values):
                            values.append(table_1.values[i] + table_2.values[i])
                            i += 1
                    ...
                    while i < len(table_1.values):
                        ...
                        while j < len(table_2.values):
                            if check_table_1 == 1 and check_table_2 == 1:
                                if (table_1.values[i][index_column_where_1] > table_1.values[i][index_column_2]):
                                    check_where = True
                                if (table_1.values[i][index_column_join_1] == table_2.values[j][index_column_join_2]):
                                    check_join = True
                                ...
                                if (table_1.values[i][index_column_where_1] > table_2.values[i][index_column_2]):
                                    check_where = True
                                if (table_1.values[i][index_column_join_1] == table_2.values[j][index_column_join_2]):
                                    check_join = True
                                ...
                                if (table_2.values[i][index_column_where_1] > table_1.values[i][index_column_2]):
                                    check_where = True
                                if (table_1.values[i][index_column_join_1] == table_2.values[j][index_column_join_2]):
                                    check_join = True
                                ...
                                if (table_2.values[i][index_column_where_1] > table_2.values[i][index_column_2]):
                                    check_where = True
                                if (table_1.values[i][index_column_join_1] == table_2.values[j][index_column_join_2]):
                                    check_join = True
